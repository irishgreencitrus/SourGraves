package io.github.irishgreencitrus.brigadierdsl
...
/**
 * A shorthand for appending an integer required argument to `this` [ArgumentBuilder]
 *
 * @see argument
 */
 ...
 */
infix fun <S> ArgumentBuilder<S, *>.does(command: (@BrigadierDsl CommandContext<S>) -> Unit) {
    executes { ctx ->
        command(ctx)
        SINGLE_SUCCESS
    }
